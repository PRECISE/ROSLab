...
<description>&lt;b&gt;Switching RegulatorL TPS621XX&lt;/b&gt;

&lt;p&gt;This block supports the fixed voltage regulators of this family: 
TPS62171 (1.8V),
TPS62172 (3.3V),
TPS62173 (5.0V)
...
&lt;p&gt;&lt;a href="http://www.ti.com/lit/ds/symlink/tps62172.pdf"&gt;TPS6217X&lt;/a&gt;&lt;/p&gt;

&lt;p&gt;&lt;a href="http://www.ti.com/lit/ds/symlink/tps62160.pdf"&gt;TPS6216X&lt;/a&gt;&lt;/p&gt;

&lt;p&gt;Includes all capacitors and inductors required.&lt;/p&gt;

&lt;p&gt;Input voltages between output voltage and 17.  If using V_BATT or V_SUPP, ensure the voltage does not fall out of these limits.&lt;/p&gt;

&lt;p&gt;Rated to 0.5A for TPS6217X.  Rated to 1.0A for TPS6216X&lt;/p&gt;</description>
<libraries>
<library name="piccoli">
<description>&lt;b&gt;PCB Matrix Packages&lt;/b&gt;&lt;p&gt;</description>
<packages>
<package name="8-WFDFN">
<smd name="P$1" x="0.75" y="0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$2" x="0.25" y="0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$3" x="-0.25" y="0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$4" x="-0.75" y="0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$5" x="-0.75" y="-0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$6" x="-0.25" y="-0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$7" x="0.25" y="-0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$8" x="0.75" y="-0.95" dx="0.25" dy="0.5" layer="1"/>
<smd name="P$9" x="0" y="0" dx="1.3" dy="0.7" layer="1"/>
...
<pin name="AGND" x="-12.7" y="0" visible="pin" length="middle" direction="pwr"/>
<pin name="PGND" x="-12.7" y="-2.54" visible="pin" length="middle" direction="pwr"/>
<pin name="SW" x="12.7" y="5.08" visible="pin" length="middle" rot="R180"/>
<pin name="VOS" x="12.7" y="2.54" visible="pin" length="middle" rot="R180"/>
<pin name="PG" x="12.7" y="0" visible="pin" length="middle" direction="out" rot="R180"/>
...
<devicesets>
<deviceset name="TPS621XX">
<gates>
<gate name="G$1" symbol="TPS621XX" x="0" y="0"/>
</gates>
<devices>
<device name="" package="8-WFDFN">
<connects>
<connect gate="G$1" pin="AGND" pad="P$4 P$9"/>
...
<parts>
<part name="U$1" library="piccoli" deviceset="TPS621XX" device=""/>
<part name="L1" library="rcl" deviceset="L-US" device="L2012C" value="2.2µH"/>
<part name="COUT_1" library="rcl" deviceset="C-US" device="C0603" value="22µF"/>
<part name="CIN_1" library="rcl" deviceset="C-US" device="C0603" value="10µF"/>
...
<sheets>
<sheet>
<description>&lt;b&gt;Switching Regulator TPS6216X, TPS6216X&lt;/b&gt;
...
&lt;p&gt;Rated to 0.5A for TPS6217X.  Rated to 1.0A for TPS6216X&lt;/p&gt;</description>
<plain>
<text x="-5.08" y="2.54" size="1.778" layer="97">The GPIO is an open drain and requires a pull up or a micro's internal pull up</text>
</plain>
<instances>
<instance part="U$1" gate="G$1" x="33.02" y="15.24"/>
<instance part="L1" gate="G$1" x="55.88" y="20.32" rot="R90"/>
<instance part="COUT_1" gate="G$1" x="78.74" y="17.78" rot="MR0"/>
<instance part="CIN_1" gate="G$1" x="12.7" y="17.78" rot="MR0"/>
<instance part="U$2" gate="G$1" x="10.16" y="22.86" rot="R90"/>
<instance part="U$3" gate="G$1" x="81.28" y="20.32" rot="R90"/>
<instance part="GND1" gate="1" x="10.16" y="7.62"/>
<instance part="GND2" gate="1" x="68.58" y="7.62"/>
<instance part="U$4" gate="G$1" x="48.26" y="15.24"/>
</instances>
<busses>
</busses>
<nets>
...
<net name="1_8V,#,+,O/3_3V,#,+,O/5V,#,+,O" class="0">
<segment>
...
<pinref part="COUT_1" gate="G$1" pin="1"/>
...
<net name="V_SUPPLY,#,+,I/V_BATT,#,+,I/3V,#,+,I/3_3V,#,+,I/3_7V,#,+,I/5V,#,+,I/6V,#,+,I/7_2V,#,+,I/7_4V,#,+,I/7_5V,#,+,I/8_4V,#,+,I/9V,#,+,I/9_6V,#,+,I/10_5V,#,+,I/11_1V,#,+,I/12V,#,+,I/14_8V,#,+,I/15V,#,+,I/17V,#,+,I" class="0">
<segment>
...
<pinref part="COUT_1" gate="G$1" pin="2"/>
