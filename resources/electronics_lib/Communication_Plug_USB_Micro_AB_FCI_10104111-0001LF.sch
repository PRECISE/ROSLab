...
<description>&lt;b&gt;Micro AB USB receptacle: FCI 10104111-0001LF&lt;/b&gt;

&lt;p&gt;
&lt;a href="http://portal.fciconnect.com/Comergent//fci/drawing/10104111.pdf"&gt; Datasheet&lt;/a&gt; &lt;/p&gt;
...
&lt;p&gt; As per USB spec, the capacitance across the USB power lines must be between 1µf and 10µf.  Use 5V_USB service and a load limiter like the FPF2123 if your board does not meet this specification or if you are unsure.&lt;/p&gt;</description>
<plain>
<text x="2.54" y="55.88" size="1.016" layer="97">As per USB spec, the capacitance across the USB power lines must be between 1µf and 10µf.  </text>
<text x="2.54" y="53.34" size="1.016" layer="97">Use 5V_USB service and a load limiter like the FPF2123 if your board does not meet this specification or if you are unsure.</text>
</plain>
<instances>
<instance part="C_USB_DC1" gate="G$1" x="22.86" y="35.56" smashed="yes" rot="MR0">
<attribute name="NAME" x="18.415" y="31.496" size="1.778" layer="95" rot="MR90"/>
<attribute name="VALUE" x="26.289" y="31.496" size="1.778" layer="96" rot="MR90"/>
</instance>
<instance part="GND18" gate="1" x="33.02" y="27.94"/>
<instance part="R2" gate="G$1" x="10.16" y="30.48" rot="MR270"/>
<instance part="R1" gate="G$1" x="30.48" y="22.86" rot="MR180"/>
<instance part="R3" gate="G$1" x="25.4" y="17.78" rot="MR180"/>
<instance part="X1" gate="G$1" x="17.78" y="12.7" rot="MR270"/>
<instance part="U$1" gate="G$1" x="25.4" y="43.18"/>
<instance part="U$2" gate="G$1" x="38.1" y="22.86"/>
<instance part="U$3" gate="G$1" x="33.02" y="17.78"/>
</instances>
<busses>
</busses>
<nets>
