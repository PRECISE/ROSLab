...
public class ComponentRoleConstraint {
	
	public String roleName;
	public Arity pubArity;
	public Arity subArity;
	
	public ComponentRoleConstraint(String roleName, Arity pubArity, Arity subArity) {
		this.roleName = roleName;
		this.pubArity = pubArity;
		this.subArity = subArity;
	}
