...
public class CompRoles {
	public static final String ROS_SERVICE = "ROS Service";
	public static final String ROS_NODE = "ROS Node";
    public static final String ROS_BUILTINS = "ROS Built-In Nodes";
}
