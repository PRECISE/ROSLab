...
public class ModuleSpec {
	...
	public String role; //component role name (AppPanel, Device, Logic)
	public ComponentSignature sig;
	public Set<String> includeDeps = new HashSet<String>();
	
	public ModuleSpec(String type, String role, ComponentSignature sig) {
		super();
		this.type = type;
		this.role = role;
		this.sig = sig;
