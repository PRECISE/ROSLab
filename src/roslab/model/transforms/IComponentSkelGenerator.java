...
public interface IComponentSkelGenerator{
	
	public void generateComponentSkeleton(String appName, String filename, ModuleSpec spec, ConfigurationSpec configPdeSpec, String instanceName) throws IOException;
